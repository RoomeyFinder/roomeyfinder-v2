  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.to(".key-shield", { scale: 1, opacity: 1, duration: 0.8, ease: "back.out(1.4)" })
        ...
        .to(
          ".key-star",
          { scale: 1, opacity: 1, stagger: 0.12, duration: 0.4, ease: "back.out(2)" },
          "-=0.1",
        )
        .to(
          ".key-hand",
          { y: -5, repeat: 1, yoyo: true, duration: 2, ease: "sine.inOut" },
          "key-idle",
        )
        .to(
          ".key-ring",
        ...
        .to(
          ".key-star",
          { scale: 1.25, repeat: 1, yoyo: true, stagger: 0.2, duration: 1.2, ease: "sine.inOut" },
          "key-idle",
        );
    }, containerRef);
  ...
  return (
    <div ref={containerRef} className="flex w-full justify-center">
      ...
      >
        {/* Shield background */}
        <path
          className="key-shield"
          d="M240 60 C180 60 140 85 140 140 C140 210 200 270 240 290 C280 270 340 210 340 140 C340 85 300 60 240 60 Z"
          fill="#009A490a"
          stroke="#009A491e"
          strokeWidth="3"
        />
        ...
        <g className="key-house">
          <polygon
            points="240,110 310,170 170,170"
            fill="#3A86FF20"
            stroke="#3A86FF"
            strokeWidth="2.5"
          />
        ...
        <g className="key-badge">
          ...
          <path
            d="M308 117 L313 122 L321 112"
            stroke="#FFFFFF"
            strokeWidth="3"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <text x="356" y="122" fill="#FFFFFF" fontWeight="bold" fontSize="12" textAnchor="middle">
            VERIFIED
          </text>
        </g>
        ...
        <g className="key-star" id="star1">
          <path
            d="M120 110 L123 116 L130 117 L125 122 L126 129 L120 126 L114 129 L115 122 L110 117 L117 116 Z"
            fill="#FBBF24"
          />
        </g>
        <g className="key-star" id="star2">
          <path
            d="M370 220 L372 224 L377 225 L373 229 L374 234 L370 232 L366 234 L367 229 L363 225 L368 224 Z"
            fill="#FBBF24"
          />
        </g>
        ...
        <g className="key-hand">
          ...
          <g className="key-ring">
            ...
            <path
              d="M215 261 L211 257 C206 252 211 247 215 251 C219 247 224 252 220 257 Z"
              fill="#FFFFFF"
            />
