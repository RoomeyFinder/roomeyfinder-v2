  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.to(".living-bg-sun", { y: 0, opacity: 0.8, duration: 1.2 })
        ...
        .to(
          ".living-steam",
          { y: -10, opacity: 1, stagger: 0.2, duration: 0.9, ease: "power1.inOut" },
          "-=0.5",
        )
        .to(".living-steam", { opacity: 0, stagger: 0.2, duration: 0.9, ease: "power1.inOut" })
        .to(
          ".living-plant-leaf-1",
          { rotation: 5, repeat: 1, yoyo: true, duration: 2.2, ease: "sine.inOut" },
          "idle",
        )
        .to(
          ".living-plant-leaf-2",
          { rotation: -5, repeat: 1, yoyo: true, duration: 2.5, ease: "sine.inOut" },
          "idle",
        )
        .to(
          ".living-plant-leaf-3",
          { rotation: 2, repeat: 1, yoyo: true, duration: 1.8, ease: "sine.inOut" },
          "idle",
        )
        .to(
          ".living-cloud-1",
          { x: 10, repeat: 1, yoyo: true, duration: 2, ease: "sine.inOut" },
          "idle",
        )
        .to(
          ".living-cloud-2",
  ...
  return (
    <div ref={containerRef} className="flex w-full justify-center">
      ...
      >
        ...
        {/* Clouds */}
        <path
          className="living-cloud-1"
          d="M120 100 C110 100 105 108 112 114 C108 118 116 126 124 122 C130 126 138 120 134 114 C138 108 130 100 120 100 Z"
          fill="#FFFFFF"
          opacity="0.9"
        />
        <path
          className="living-cloud-2"
          d="M340 90 C332 90 328 96 333 101 C330 104 336 111 343 108 C348 111 354 106 351 101 C354 96 348 90 340 90 Z"
          fill="#FFFFFF"
          opacity="0.8"
        />
        ...
        <g className="living-table">
          ...
          <path
            className="living-steam"
            d="M226 242 Q224 237 228 232 T226 225"
            stroke="#3A86FF"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
          <path
            className="living-steam"
            d="M254 242 Q252 237 256 232 T254 225"
            stroke="#009A49"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
        ...
        <g className="living-plant">
          ...
          <path
            className="living-plant-leaf-1"
            d="M386 245 C370 230 360 210 362 195 C375 210 384 230 386 245 Z"
            fill="#10B981"
          />
          <path
            className="living-plant-leaf-2"
            d="M386 245 C402 230 412 210 410 195 C397 210 388 230 386 245 Z"
            fill="#047857"
          />
          <path
            className="living-plant-leaf-3"
            d="M386 245 C386 220 380 200 386 185 C392 200 386 220 386 245 Z"
            fill="#34D399"
          />
        </g>
        ...
        <g className="living-lamp">
          ...
          <polygon
            className="living-lamp-light"
            points="75,150 35,280 145,280"
            fill="#FDE047"
            opacity="0.3"
