...
export const SmartMapDiscovery = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set(".search-radar-pulse", {
        scale: 0.3,
        opacity: 0.8,
        transformOrigin: "center center",
      });
      gsap.set(".search-filter-tag", { x: -20, opacity: 0 });
      gsap.set(".search-lens", {
        rotation: -30,
        scale: 0.8,
        opacity: 0,
        transformOrigin: "center center",
      ...
      tl.to(".search-bg-grid", { opacity: 0.08, duration: 0.8 })
        ...
        .to(
          ".search-pin",
          { scale: 1, opacity: 1, stagger: 0.15, duration: 0.6, ease: "back.out(1.8)" },
          "-=0.3",
        )
        .to(
          ".search-lens",
          { rotation: 0, scale: 1, opacity: 1, duration: 0.7, ease: "back.out(1.3)" },
          "-=0.2",
        )
        .to(
          ".search-filter-tag",
        ...
        .to(
          ".search-radar-pulse",
          { scale: 3, opacity: 0, repeat: 1, duration: 2.2, ease: "power1.out" },
          "-=0.5",
        )
        .to(
          ".search-lens",
          { x: 8, y: -5, repeat: 1, yoyo: true, duration: 2.5, ease: "sine.inOut" },
          "search-idle",
        )
        .to(
          ".search-pin",
          { y: -4, repeat: 1, yoyo: true, stagger: 0.15, duration: 1.5, ease: "sine.inOut" },
          "search-idle",
        );
    }, containerRef);
    ...
    <div ref={containerRef} className="flex w-full justify-center">
      ...
      >
        ...
        <g className="search-pin" id="pin-1">
          ...
          <path
            d="M160 115 C150 115 142 123 142 133 C142 145 160 165 160 165 C160 165 178 145 178 133 C178 123 170 115 160 115 Z"
            fill="#009A49"
          />
        ...
        <g className="search-pin" id="pin-2">
          ...
          <path
            d="M320 195 C310 195 302 203 302 213 C302 225 320 245 320 245 C320 245 338 225 338 213 C338 203 330 195 320 195 Z"
            fill="#009A49"
          />
        ...
        <g className="search-pin" id="pin-3">
          ...
          <path
            d="M270 85 C260 85 252 93 252 103 C252 115 270 135 270 135 C270 135 288 115 288 103 C288 93 280 85 270 85 Z"
            fill="#3A86FF"
          />
        ...
        <g className="search-card">
          ...
          <path
            d="M351 302.5 L354 305.5 L360 299.5"
            stroke="#FFFFFF"
            strokeWidth="2.5"
            strokeLinecap="round"
        ...
        <g className="search-lens">
          ...
          <path
            d="M190 140 A 45 45 0 0 1 245 130"
            stroke="#FFFFFF"
            strokeWidth="3"
            strokeLinecap="round"
            opacity="0.4"
        ...
        <g className="search-filter-tag" id="filter-1">
          ...
          <text x="102.5" y="42" fill="#FFFFFF" fontWeight="bold" fontSize="10" textAnchor="middle">
            📍 Near Rumuola
          </text>
        </g>
        <g className="search-filter-tag" id="filter-2">
          <rect
            ...
            strokeWidth="1.5"
          />
          <text x="207.5" y="42" fill="#3A86FF" fontWeight="bold" fontSize="10" textAnchor="middle">
            💰 Max ₦80,000/mo
          </text>
        </g>
        <g className="search-filter-tag" id="filter-3">
          <rect
            ...
            strokeWidth="1.5"
          />
          <text x="322.5" y="42" fill="#009A49" fontWeight="bold" fontSize="10" textAnchor="middle">
            🐾 Pet Friendly
          </text>
        </g>
      </svg>
