  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.to(".match-avatar-l", { x: 0, opacity: 1, scale: 1, duration: 0.8 })
        ...
        .to(
          ".match-node",
          { y: -6, repeat: 1, yoyo: true, duration: 1.8, stagger: 0.1, ease: "sine.inOut" },
          "-=1.5",
        );
    }, containerRef);
    ...
    <div ref={containerRef} className="flex w-full justify-center">
      ...
      >
        ...
        <g className="match-avatar-l">
          ...
          <path
            d="M100 215 C100 200 110 190 120 190 H140 C150 190 160 200 160 215 Z"
            fill="#3A86FF"
          />
        ...
        <g className="match-avatar-r">
          ...
          <path
            d="M320 215 C320 200 330 190 340 190 H360 C370 190 380 200 380 215 Z"
            fill="#009A49"
          />
        ...
        <g className="match-badge">
          ...
          <text x="240" y="185" fill="#FFFFFF" fontWeight="900" fontSize="14" textAnchor="middle">
            98% MATCH
          </text>
        </g>
      </svg>
